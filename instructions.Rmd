...
their computers. In cases where a workshop is hosted by an organisation
a computer laboratory is often used and technicians are invited to
assist with ensuring that machines contain the required software.
