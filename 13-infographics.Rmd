...
Click on one of the template infograms with a graph such as Amsterdam and then click inside the graph box itself and select the edit button in the top right. 
...
Infogram allows the creation of various graph types, including wordclouds and treemaps. In this way the most common concepts or phrases used in the dataset can be visualized, after they have been identified through Vantage Point or another data mining tool. URLs, pictures and videos can also be included in an Infogram Infographic and make it more appealing.
