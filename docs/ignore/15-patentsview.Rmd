---
title: "Using the Patentsview API for Patent Analytics"
author:
- name: Enric Escorsa
...
output:
  html_document:
    df_print: paged
description: |
  Learn to use the USPTO PatentsView API.
---
...
![](images/patentsview/fig1_front.png)
...
load("~/Documents/GitHub/wipo-analytics.github.io/data/pv_out.rda")
```
...
load("~/Documents/GitHub/wipo-analytics.github.io/data/dl.rda")
```
