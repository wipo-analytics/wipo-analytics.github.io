...
Next you will be asked to select the file to use. We will download and then unzip the [gephi_drones_fulltext_cleaned_5884.csv](https://github.com/wipo-analytics/drones_data/raw/master/use_me/gephi/gephi_drones_fulltext_cleaned_5884.csv.zip) file that is located on the WIPO Analytics website on GitHub.
